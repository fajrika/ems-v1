...
class P_transaksi2_registrasi_tvi extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('m_transaksi2_registrasi_tvi');
    ...
    {
        $data = $this->m_transaksi2_registrasi_tvi->getAll();
    ...
    {
        $this->load->model('m_transaksi2_registrasi_tvi');
        $dataUnit = $this->m_transaksi2_registrasi_tvi->getUnit();
        $dataCustomer = $this->m_transaksi2_registrasi_tvi->getCustomer();
        $dataPaket = $this->m_transaksi2_registrasi_tvi->getPaket();
        $this->load->view('core/header');
        $this->load->view('core/side_bar', ['menu' => $GLOBALS['menu']]);
    ...
    {	
        ...
        {
        $status = $this->m_transaksi2_registrasi_tvi->save([
    ...
    public function lihat_unit()
    {
        ...
        echo json_encode($this->m_transaksi2_registrasi_tvi->getUnit2($pilih_unit));
    }
    ...
    public function lihat_customer()
    {
        ...
        echo json_encode($this->m_transaksi2_registrasi_tvi->getCustomer2($pilih_customer));
    }
     ...
     public function lihat_paket()
    {
        ...
        echo json_encode($this->m_transaksi2_registrasi_tvi->getPaket2($pilih_paket));
    }
