...
class Kubikasi_air extends CI_Controller {
    ...
    public function request_data_json()
    {
        ...
        $columns = array(
            ...
            array('db' => 'periode_pemakaian', 'dt' => 4),
            array('db' => 'meter_awal', 'dt' => 5),
            array('db' => 'meter_akhir', 'dt' => 6),
            array('db' => 'meter_pakai', 'dt' => 7),
            array('db' => 'nilai_pakai', 'dt' => 8),
        );
        $sql_details = array(
    ...
    /*public function request_data_air()
    {
        ...
        foreach ($query->result_array() as $row) {
            ...
            $nestedData[] = $row['kawasan'].' - '.$row['unit_id'];
    ...
    public function export_excel()
    {
        ...
        //Style Judul table
        $spreadsheet->getActiveSheet()->setCellValue('A1', "LAPORAN PEMAKAIAN AIR")->mergeCells("A1:I1");
        ...
        if ($sql->num_rows() > 0) 
        {
            ...
            {
                $spreadsheet->getActiveSheet()->setCellValue('A'.$nomor, $d->nama_kawasan);
