...
class P_schedule_email  extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('proyek/tools/m_schedule_email');
    ...
    {
        $data = $this->m_schedule_email->get();
        $this->load->view('core/header');
        $this->load->view('core/side_bar', ['menu' => $GLOBALS['menu']]);
        $this->load->view('core/top_bar', ['jabatan' => $GLOBALS['jabatan'], 'project' => $GLOBALS['project']]);
        $this->load->view('core/body_header', ['title' => 'Tools > Email > Schedule ', 'subTitle' => 'List']);
        $this->load->view('proyek/tools/schedule_email/view' , ['data' => $data]);
