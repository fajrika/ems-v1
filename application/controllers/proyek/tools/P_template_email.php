...
class P_template_email  extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('proyek/tools/m_template_email');
    ...
    {
        $data = $this->m_template_email->get();
        $this->load->view('core/header');
        $this->load->view('core/side_bar', ['menu' => $GLOBALS['menu']]);
        $this->load->view('core/top_bar', ['jabatan' => $GLOBALS['jabatan'], 'project' => $GLOBALS['project']]);
        $this->load->view('core/body_header', ['title' => 'Tools > Email > Template', 'subTitle' => 'List']);
        $this->load->view('proyek/tools/template_email/view' , ['data' => $data]);
