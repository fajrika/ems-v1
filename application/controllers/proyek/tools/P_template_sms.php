...
class P_template_sms  extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('proyek/tools/m_template_sms');
    ...
    {
        $data = $this->m_template_sms->get();
        $this->load->view('core/header');
        $this->load->view('core/side_bar', ['menu' => $GLOBALS['menu']]);
        $this->load->view('core/top_bar', ['jabatan' => $GLOBALS['jabatan'], 'project' => $GLOBALS['project']]);
        $this->load->view('core/body_header', ['title' => 'Tools > SMS > Template', 'subTitle' => 'List']);
        $this->load->view('proyek/tools/template_sms/view' , ['data' => $data]);
