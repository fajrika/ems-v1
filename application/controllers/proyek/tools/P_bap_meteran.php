...
class P_bap_meteran  extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('proyek/tools/m_bap_meteran');
    ...
    {
        $data = $this->m_bap_meteran->getAll();
        $this->load->view('core/header');
        $this->load->view('core/side_bar', ['menu' => $GLOBALS['menu']]);
        $this->load->view('core/top_bar', ['jabatan' => $GLOBALS['jabatan'], 'project' => $GLOBALS['project']]);
        $this->load->view('core/body_header', ['title' => 'Tools > BAP Pemutusan Penyambungan Meteran', 'subTitle' => 'List']);
        $this->load->view('proyek/tools/bap_meteran/view' , ['data' => $data]);
    ...
    public function add()
    {
        ...
        $dataUnit = $this->m_bap_meteran->getUnit();
        $dataService = $this->m_bap_meteran->get_service_non_retribusi();
        ...
        $this->load->view('proyek/tools/bap_meteran/add', [
                            'no_regis' => $no_regis,
                            'dataUnit' => $dataUnit,
