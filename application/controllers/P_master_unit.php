...
class P_master_unit extends CI_Controller
{
    ...
    public function edit_modal()
    {
        ...
        if ($this->m_unit->cek($this->input->get('id'))) {
            ...
            $this->load->view('core/body_header_modal', ['title' => 'Master > Town Planning > Unit', 'subTitle' => 'Edit']);
            
            $this->load->view('proyek/master/unit/edit_modal', [
                'dataSelect' => $dataSelect,
                'dataBlok' => $dataBlok,
                'dataGolongan' => $dataGolongan,
                'dataSubGol' => $dataSubGol,
            ...
            echo '<H1 align="center">Data Tidak Ditemukan!</H1>';
        }
