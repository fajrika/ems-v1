...
class P_spk extends CI_Controller
{
    ...
    public function perjanjianPasar()
    {
        $this->load->view('core/header');
        $this->load->view('core/side_bar', ['menu' => $GLOBALS['menu']]);
        $this->load->view('core/top_bar', ['jabatan' => $GLOBALS['jabatan'], 'project' => $GLOBALS['project']]);
        $this->load->view('core/body_header', ['title' => 'Surat Perjanjian Kontrak (SPK) > Surat Perjanjian Pasar', 'subTitle' => 'Surat Perjanjian Pasar']);
        $this->load->view('proyek/transaksi_lain/spk/dashboard');
        $this->load->view('core/body_footer');
        $this->load->view('core/footer');
	}
    

    public function cetakPerjanjianPasar()
    {
        ...
        $this->pdf->filename = "perjanjian-pasar.pdf";
        
        $this->pdf->load_view('proyek/cetakan/perjanjian_pasar');
