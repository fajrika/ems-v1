...
class P_transaksi_pembayaran_one_bill extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('core/body_header', ['title' => 'Transaksi Service > Pembayaran One Bill', 'subTitle' => 'List']);
        $this->load->view('proyek/transaksi/pembayaran_one_bill/view');
