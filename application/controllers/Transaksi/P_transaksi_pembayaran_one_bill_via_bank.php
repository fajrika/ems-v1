...
class P_transaksi_pembayaran_one_bill_via_bank extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('core/body_header', ['title' => 'Transaksi Service > Pembayaran One Bill Via Bank', 'subTitle' => 'List']);
        $this->load->view('proyek/transaksi/pembayaran_one_bill_via_bank/view');
