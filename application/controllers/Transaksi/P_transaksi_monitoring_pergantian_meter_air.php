...
class P_transaksi_monitoring_pergantian_meter_air extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('core/body_header', ['title' => 'Transaksi Service > Monitoring Pergantian Meter Air', 'subTitle' => 'List']);
        $this->load->view('proyek/transaksi/monitoring_pergantian_meter_air/view');
