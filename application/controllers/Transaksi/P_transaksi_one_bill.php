...
class P_transaksi_one_bill extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('core/body_header', ['title' => 'Transaksi Service > Transaksi One Bill > Transaksi One Bill', 'subTitle' => 'List']);
        $this->load->view('proyek/transaksi/transaksi_one_bill/view');
