...
class P_transaksi_bap extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('core/body_header', ['title' => 'Transaksi Service > BAP', 'subTitle' => 'List']);
        $this->load->view('proyek/transaksi/bap/view');
