...
class P_transaksi_generate_pembayaran_one_bill extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('core/body_header', ['title' => 'Transaksi Service > Generate Pembayaran One Bill', 'subTitle' => 'List']);
        $this->load->view('proyek/transaksi/generate_pembayaran_one_bill/view');
