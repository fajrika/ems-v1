...
class P_transaksi_posting_one_bill extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('core/body_header', ['title' => 'Transaksi Service > Posting One Bill', 'subTitle' => 'List']);
        $this->load->view('proyek/transaksi/posting_one_bill/view');
