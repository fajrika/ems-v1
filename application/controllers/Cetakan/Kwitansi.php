...
class kwitansi extends CI_Controller {
    ...
    public function gabungan()
    {
        ...
        redirect("cetakan/kwitansi-new/all/".$pembayaran_id_gabungan[0]);
        exit();
        ...
        $tagihan = $this->db
                        ->select(" 
                                REPLACE(CONVERT(varchar, CAST(sum(isnull
                                        (t_pembayaran_detail.bayar,t_pembayaran_detail.bayar_deposit)-(t_pembayaran_detail.nilai_denda+t_pembayaran_detail.nilai_penalti)
