								...
								if (abc.parameter == 1) {
									...
									$.each($("#tbody_unit").find("tr"), function(k, v) {
										...
										if ((check_bayar == 1 || check_bayar_deposit == 1) && $("#tbody_unit").find("tr").eq(k).children().eq(2).html() >= '<?= date("Y-m-01") ?>') {
											a =
												unformatNumber($("#tbody_unit").find("tr").eq(k).find("td").eq(
													$("#tbody_unit").find("tr").eq(1).find("td").length - 2
												).html()) *
												abc.nilai;
									...
									console.log(
										unformatNumber($("#tbody_unit").find("tr").eq(1).find("td").eq(
											$("#tbody_unit").find("tr").eq(1).find("td").length - 2
										).html())
									);
									console.log(a);
