...
<script type="text/javascript">
	...
	function set_prediksi() {
		...
		var nilai_pemutihan_pokok = $("#nilai_pemutihan_pokok").val();
		var nilai_pemutihan_denda = $("#nilai_pemutihan_denda").val();
		if (nilai_pemutihan_pokok==null||nilai_pemutihan_pokok=="")
		{
			$("#nilai_pemutihan_pokok").val(0);
		}
		if (nilai_pemutihan_denda==null||nilai_pemutihan_denda=="")
		{
			$("#nilai_pemutihan_denda").val(0);
		}
