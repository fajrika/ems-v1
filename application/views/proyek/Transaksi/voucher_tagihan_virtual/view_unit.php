...
<script>
    ...
    $(function() {
        $("#btn-load").click(function(){
            $.ajax({
                url: '<?=site_url('Transaksi/P_voucher_tagihan_virtual/ajax_get_voucher');?>',
                type: "GET",
                data: {
        ...
        $("#btn-kirim-detail").click(function() {
            ...
            $.ajax({
                url: "<?=site_url('Transaksi/P_voucher_tagihan_virtual/test');?>",
                type: "GET",
                data: {
        ...
        $("#btn-validasi-detail").click(function(){
            ...
            $.ajax({
                ...
                url: '<?=site_url()?>/Transaksi/P_voucher_tagihan_virtual/ajax_validasi_gabungan',
                dataType: "json",
                success: function(data) {
                    validasi = 0;
                    $.each($("#tbody_detail").children(), function( i, v ) {
        ...
        $("body").on("click",".btn-detail",function(){
            ...
            url = '<?= site_url() ?>/Transaksi/P_voucher_tagihan_virtual/ajax_get_detail';
            $.ajax({
                type: "GET",
                data: {
