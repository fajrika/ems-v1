				...
				<table class="table table-striped jambo_table bulk_action">
					...
					<tbody id="tbody_kawasan">
						<?php
                                ...
                                //     <td>
                                //     <a href='" . site_url() . "/Transaksi/P_tagihan/Blok?id=$v->id' class='btn btn-primary col-md-10'>
				...
				$("#btn-load-kawasan").click(function() {
					...
					if ($("#periode").val() != null) {
						$.ajax({
							...
							url: "<?= site_url() ?>/Transaksi/P_tagihan/ajax_get_kawasan2",
							dataType: "json",
							success: function(data) {
								...
								for (var i = 0; i < data.length; i++) {
									...
									$("#tbody_kawasan").append(
										...
										"<td class='col-md-1'><a href='<?= site_url(); ?>/Transaksi/P_tagihan/Blok?id="+data[i].kawasan_id+"&periode="+$("#periode").val()+"' class='save-row btn btn-primary' unit_id='" + data[i].id + "'><i class='fa fa-book'></i></a></td>" +
										"</tr>");
								}
