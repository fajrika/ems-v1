...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/transaksi_lain/p_survei_liaison_officer/save?id=<?=$this->input->get('id');?>">
					...
					<div class="col-md-6">
                    	<div class="form-group two start ">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class='input-group date '>
									<input type="text" class="form-control datetimepicker" name="tanggal_survei" 
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<label style="padding-top: 6px;">
									...
									<input id="hasil_survei" type="checkbox" name="hasil_survei" class="js-switch" />
						...
						<div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<textarea class="form-control" name="keterangan_survei" id="keterangan" placeholder="Masukkan keterangan"></textarea>
							</div>
						</div>
					</div>
				</div>
