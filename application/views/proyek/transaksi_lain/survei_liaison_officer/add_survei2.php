...
<div style="float:right">
	<h2>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url()?>/transaksi_lain/P_survei_liaison_officer'">
...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/transaksi_lain/p_survei_liaison_officer/save2?id=<?=$this->input->get('id');?>">
		...
		<div id="view_data">
					...
					<div class="form-group two ">
						<table class="table table-responsive">
							...
							<tbody>
								...
								<tr>
									<td>
										<input id="nama_item" name="nama_item1" disabled value="<?=$v['nama_item']?>" class="nama_item form-control col-md-1 col-xs-12">
									</td>
									<td>
										<input id="volume" name="volume1" disabled value="<?=$v['volume']?>" class="volume form-control col-md-1 col-xs-12 currency">
									</td>
									<td>
										<input id="satuan" name="satuan1" disabled value="<?=$v['satuan']?>" class="satuan form-control col-md-1 col-xs-12">
									</td>
									<td>
										<img src="<?php echo base_url('assets/dokumen/'.$v['bukti_survei'].'');?>" alt="Gambar Item" height="50px"  onerror="this.style.display='none'" width="50px">
									</td>
								</tr>
								<?php }?>
							</tbody>
			...
			<div class="clearfix"></div>
			<h4 id="label_transaksi">Item Tambahan</h4>
			<hr id="hr_item">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group two ">
						<table class="table table-responsive">
							...
							<tbody id="tbody">
								<tr class="isi">
									<td>
										<input id="nama_item" name="nama_item[]" required="" value="" class="nama_item form-control col-md-1 col-xs-12" require>
									</td>
									<td>
										<input id="volume" name="volume[]" required="" value="" class="volume form-control col-md-1 col-xs-12 currency" require>
									</td>
									<td>
										<input id="satuan" name="satuan[]" required="" class="satuan form-control col-md-1 col-xs-12" require>
									</td>
									<td>
										<input type="file" name="bukti_survei[]" class="bukti_survei form-control col-md-1 col-xs-12" require>
									</td>
									<td>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-6">
                        <div class="form-group two ">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal Realisasi Survei 1</label>
                    	...
                    	<div class="form-group two start ">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal Realisasi Survei 2</label>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class='input-group date '>
									<input type="text" class="form-control datetimepicker" name="tanggal_survei2" 
									id="tanggal_rencana_survei" value="<?= date('d-m-Y') ?>" placeholder="Masukkan Tanggal Rencana Survei"> <span class="input-group-addon">
										<span class="glyphicon glyphicon-calendar"></span>
									</span>
								</div>
							</div>
							<label class="control-label col-md-1 col-sm-1 col-xs-12">Hasil Survei</label>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<label style="padding-top: 6px;">
									<p style="display:contents;font-size: 10px;">Pending</p>
									<input id="hasil_survei2" type="checkbox" name="hasil_survei2" class="js-switch" />
						...
						<div class="form-group two">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Keterangan Survei</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<textarea class="form-control" name="keterangan_survei2" id="keterangan" placeholder="Masukkan keterangan"></textarea>
							</div>
						</div>
					</div>
				</div>
