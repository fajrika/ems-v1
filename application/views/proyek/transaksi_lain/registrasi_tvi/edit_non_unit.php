...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url(); ?>/transaksi_lain/P_registrasi_tvi/edit_non_unit?id=<?=$this->input->get('id'); ?>">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<div class="form-group non_unit">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="nomor_registrasi2" id="nomor_registrasi2" value="<?=$data_select->nomor_registrasi; ?>" readonly class="form-control non_unit">
							</div>
						</div>
						<div class="form-group non_unit">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Telp</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="nomor_telepon2" id="nomor_telepon2" placeholder="Masukkan Nomor Telepon" value="<?=$data_select->telepon; ?>"
								 class="form-control non_unit " readonly>
							</div>
						</div>
						<div class="form-group non_unit">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">No Hp</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" placeholder="Masukkan Nomor Handphone" name="nomor_handphone2" id="nomor_handphone2" value="<?=$data_select->no_hp; ?>"
								 class="form-control non_unit " readonly>
							</div>
						</div>
						<div class="form-group non_unit">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="email" placeholder="Masukkan Email" name="email2" id="email2" value="<?=$data_select->email; ?>" class="form-control non_unit "  readonly>
							</div>
						</div>
