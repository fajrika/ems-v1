...
<!DOCTYPE html>
    <div style="float:right">
        <h2>
            <button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/transaksi_lain/p_registrasi_liason_officer/add'">
            ...
            <button class="btn btn-success" onClick="window.location.href='<?=site_url()?>/transaksi_lain/p_registrasi_liason_officer'">>
            ...
            <table class="table table-striped jambo_table tableDT">
                ...
                <?php
                     ...
                     foreach ($data as $key => $v) {
                         ...
                         echo "<td>$v[nomor_pembayaran])</td>";
                         echo "<td>$v[tanggal_pembayaran]</td>";
                         echo '<td>'.number_format($v['total_bayar']).'</td>';
                         echo"
                             <td class='col-md-1'>
                             <a href='".site_url()."/P_pembayaran_liason_ooficer/edit?id=$v[id]' class='btn btn-sm btn-primary col-md-12'>
