...
<div style="float:right">
	<h2>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url()?>/transaksi_lain/P_monitoring_liaison_officer'">
...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/transaksi_lain/p_monitoring_liaison_officer/save?id=<?=$this->input->get('id');?>">
			...
			<div class="col-md-12">
				<div class="col-md-6">
					...
					<div class="form-group two">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="text" class="form-control currency" readonly id="deposit_pakai" name="deposit_pemakaian" value='<?=number_format('0')?>'>
						</div>
					</div>
					<div class="form-group two">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Sisa Deposit</label>
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="text" class="form-control currency" name="sisa_deposit" id="sisa_deposit" readonly value="<?=number_format('0')?>">
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group two">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Kekurangan</label>
						<div class="col-md-9 col-sm-9 col-xs-12">
