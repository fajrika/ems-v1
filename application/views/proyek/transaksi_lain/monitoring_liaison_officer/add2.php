...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/transaksi_lain/p_monitoring_liaison_officer/save2?id=<?=$this->input->get('id');?>">
		...
		<div id="view_data">
			...
			<hr>
			<div class="col-md-6">
				<?php if($dataSelect->deposit_masuk < $dataSelect->deposit_pemakaian){?>
				<div class="form-group two">
					<label class="control-label col-md-3 col-sm-3 col-xs-12">Deposit</label>
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" class="form-control" name="deposit_masuk" id="deposit_masuk" value='0' readonly>
					</div>
                </div>
                <?php }else{?>
                <div class="form-group two">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Saldo Deposit</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" name="deposit_masuk" id="deposit_masuk" value='<?=number_format($dataSelect->deposit_masuk-$dataSelect->deposit_pemakaian)?>' readonly>
                    </div>
                </div>
                <?php }?>
				<div class="form-group two">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" class="form-control currency" value="<?=number_format('0')?>" readonly id="deposit_pakai" name="deposit_pemakaian2">
						<input type="text" class="form-control currency" style="display:none;" value="<?=number_format('0')?>" readonly id="deposit_pakai" name="deposit_pemakaian" hidden="">
					</div>
				</div>
				<div class="form-group two">
					<label class="control-label col-md-3 col-sm-3 col-xs-12">Sisa Deposit</label>
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" class="form-control currency"  name="sisa_deposit" id="sisa_deposit" value="<?=number_format('0')?>" readonly>
					</div>
				</div>
			</div>
			<div class="clearfix"></div>
						...
						<table class="table table-responsive">
							...
							<tbody>
								...
								<tr class="isi">
									...
									<td>
										<input id="harga_satuan" name="harga_satuan[]" value="<?=number_format('0')?>" class="harga_satuan form-control col-md-1 col-xs-12 currency" >
									</td>
									<td>
										<input id="total" name="total[]" value="<?=number_format('0')?>" disabled class="total form-control col-md-1 col-xs-12 currency">
									</td>
									<td hidden>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
                        ...
                        <div class="form-group two ">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal Realisasi Instalasi</label>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class='input-group date '>
...
<script type="text/javascript">
	...
	$("body").on("keyup",".harga_satuan",function(){
		...
		if (formatNumber(sisa)>=formatNumber(0)){
			...
			$("#sisa_deposit").val(formatNumber(0));
			$("#kekurangan").val(formatNumber(unformatNumber(deposit_pakai)-unformatNumber(deposit_masuk)));
		}
