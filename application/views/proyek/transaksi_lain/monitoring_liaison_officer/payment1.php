...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/transaksi_lain/p_monitoring_liaison_officer/aksi_pembayaran1?id=<?=$this->input->get('id');?>">
						...
						<table class="table table-responsive">
							...
							<tbody>
								...
								<tr class="isi">
									...
									<td>
										<input id="harga_satuan" name="harga_satuan[]" disabled value="<?=number_format($v['harga_satuan'])?>" class="harga_satuan form-control col-md-1 col-xs-12 currency">
									</td>
									<td>
										<input id="total" name="total[]" value="<?=number_format($v['harga_satuan']*$v['volume'])?>" disabled class="total form-control col-md-1 col-xs-12 currency">
									</td>
									<td hidden>
				...
				<div class="col-md-12">
					<div class="col-md-6">
                        ...
                        <div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="totalpaket" readonly="" value="<?= number_format($dataSelect->deposit_masuk)?>" id="totalpaket" class="form-control currency">
							</div>
                        </div>
                        <div class="form-group two">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Deposit Pemakaian</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="totalpaket" readonly="" value="<?= number_format($dataSelect->deposit_pemakaian)?>" id="totalpaket" class="form-control currency">
							</div>
						</div>
						<div class="form-group two">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Deposit Kekurangan</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="totalpaket" readonly="" value="<?= number_format($dataSelect->sisa_deposit)?>" id="totalpaket" class="form-control currency">
							</div>
						</div>
						<div class="form-group two">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Total Yang Harus Dibayar</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="total_survei1" value="<?= number_format($dataSelect->sisa_deposit)?>" readonly="" id="total_bayar" value="0" class="form-control currency">
							</div>
						</div>
							...
							<div class="col-md-5 col-sm-12 col-xs-2">
								<div class="checkbox">
									<label>
										...
										<input type="checkbox" name="status_bayar_survei1" class="js-switch" value="1" />
