...
<!DOCTYPE html>
    <div style="float:right">
        <h2>
            <button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/proyek/tools/P_group_sms_email/add'">
            ...
            <button class="btn btn-success" onClick="window.location.href='<?=site_url()?>/proyek/tools/P_group_sms_email'">>
