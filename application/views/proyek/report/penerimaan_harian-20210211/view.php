    ...
    <div class="table-responsive">
        <div id="area-tb-penerimaan" class="col-lg-12 col-md-12 col-sm-12" style="margin-top:20px">
            <table class="table table-striped jambo_table" id="tb-penerimaan" style="width:100%">
                <thead>
                    <tr>
                        <th colspan="14" style="text-align: center;">Penerimaan Harian</th>
                    </tr>
                    <tr>
                ...
                <tbody id="load_data"><tr><td colspan="14" align="center">No data available in table</td></tr></tbody>
            </table>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click', '#export-excel', function(e){
            ...
            {
                variable = '?id_kawasan='+kawasan+'&id_blok='+blok+'&periode_awal='+periode_awal+'&periode_akhir='+periode_akhir+'&jenis_service='+jenis_service+'&pt_id='+pt_id;
