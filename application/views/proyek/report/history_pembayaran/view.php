                    ...
                    <div id="div_table_ipl" class="col-md-12 card-box table-responsive">
                        <div class="dataTables_scrollBody" style="position: relative; overflow: auto; max-height: 550px; width: 100%;">
                            <table id='table-history-1' class="table table-strip">
                                ...
                                <tbody id='tbody-history-1'></tbody>
                            </table>
                        </div>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(k, v) {
                        ...
                        str = str + "<td style='white-space: nowrap;'>" + (v.nama_pt==null ? '-' : v.nama_pt) + "</td>";
                        str = str + "<td>" + (v.no_kwitansi==null ? '-' : v.no_kwitansi) + "</td>";
                        ...
                        str = str + "<td class='text-right'>" + formatNumber(v.nilai_diskon_ipl) + "</td>";
                        ...
                        str = str + "<td class='text-right'>" + formatNumber(v.bayar_ipl - v.nilai_diskon_ipl) + "</td>";
                        ...
                        str = str + "<td class='text-right'>" + formatNumber(((v.bayar_ipl=='-'?0:v.bayar_ipl) + (v.bayar_air=='-'?0:v.bayar_air)) - v.nilai_diskon_ipl) + "</td>";
