...
<style type="text/css">
    ...
    #tb-meterair thead th { vertical-align: middle; text-align: center; }
    #tb-meterair tbody td:nth-child(2), 
    #tb-meterair tbody td:nth-child(4) { 
        white-space: nowrap;
    }
...
<div class="x_conte nt">
    ...
    <form action="" id="form-meterair" class="form-horizontal form-label-left" method="post" novalidate>
        ...
        <div class="field item form-group">
            ...
            <div class="col-md-6 col-xs-12">
                <select name="jenis_transaksi" id="jenis_transaksi" class="form-control select2" placeholder="-- Pilih Transaksi --" style="width: 100%;">
        ...
        <div class="field item form-group">
            <label class="control-label col-md-3 col-xs-12">Tgl. Transaksi Awal/Akhir</label>
            <div class="col-md-3">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12" style="margin-top:20px">
        <table class="table table-striped jambo_table" id="tb-meterair" style="width:100%">
            <tfoot id="tfoot" style="display: table-header-group;">
                <tr>
                    ...
                    <th class="no-sort">Tgl. Transaksi</th>
            ...
            <thead>
                <tr>
                    ...
                    <th>Sub. Golongan</th>
                    <th>No. Seri Meter</th>
                    <th class="no-sort">Tgl. Pasang</th>
                    <th class="no-sort">Tgl. Aktif</th>
                    <th class="no-sort">Tgl. Pemutusan</th>
                    <th class="no-sort">Tgl. Transaksi</th>
                    <th class="no-sort">Meter Awal</th>
                    <th class="no-sort">Meter Akhir</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click', '#btn-load-unit', function(e){
            ...
            else
            {
                ...
                dataTable = $('#tb-meterair').DataTable({
                    ...
                    "ajax": {
                        url: "<?= site_url('report/history-meter-air/load-table'); ?>",
                        type: "get",
                        data: {
                            kawasan: kawasan,
                            blok: blok,
                        ...
                        error: function() {
                            ...
                            $("#tb-meterair").append('<tbody class="my-grid-error"><tr><th colspan="12"><center>No data found in the server</center></th></tr></tbody>');
        ...
        $(document).on('click', '#export-excel', function(e){
            ...
            {
                variable  = '?id_kawasan='+kawasan;
                variable += '&id_blok='+blok;
                variable += '&periode_awal='+periode_awal;
                variable += '&periode_akhir='+periode_akhir;
                variable += '&jenis_transaksi='+jenis_transaksi;
                window.open("<?=site_url('report/history-meter-air/export-excel/');?>"+variable);
            }
        });
    });
