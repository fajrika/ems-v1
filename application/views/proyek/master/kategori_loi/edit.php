        ...
        <div class="col-md-12 col-xs-12">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" disabled name="kode" id="kode" value="<?=$dataSelect->kode?>" placeholder="Masukkan Kode Kategori">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kategori</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" disabled name="nama" id="nama" value="<?= $dataSelect->nama?>" placeholder="Masukkan Nama Kategori">
                </div>
            </div>
        </div>
		<div class="col-md-12">
        ...
        $(function() {
            ...
            $("#form").submit(function(e){
                ...
                $.ajax({
                    type: "GET",
                    data: $("#form").serialize(),
                    url: "<?= site_url() ?>/P_master_kategori_loi/ajax_edit?id=<?=$dataSelect->id?>",
                    dataType: "json",
