    ...
    <form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?= site_url(); ?>/P_master_range_lingkungan/edit?id=<?= $this->input->get('id'); ?>">
        <div class="col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <input type="text" class="form-control " required name="kode_range" placeholder="Masukkan Kode Range" value="<?= $data_select->code; ?>" readonly>
                </div>
            </div>
        ...
        <div class="col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control numbering disabled-form currency" required name="keamanan" placeholder="IDR" value="<?= $data_select->keamanan; ?>" disabled>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-4">Kebersihan ( Rp/Bln )</label>
                <div class="col-md-8">
                    <input type="text" class="form-control numbering disabled-form currency" required name="kebersihan" placeholder="IDR" value="<?= $data_select->kebersihan; ?>" disabled>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control numbering disabled-form currency" required name="service_charge" placeholder="IDR" value="<?= $data_select->service_charge; ?>" disabled>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-md-4">Ppn Service Charge</label>
                <div class="col-md-8">
                    <div class="">
                        <label>
    ...
    $(function() {
        $("#flag_bangunan").change(function() {
            if ($("#flag_bangunan").is(':checked')) {
                ...
                $("#formula_bangunan").val('0').trigger('change');
                ...
                if ($("#formula_bangunan").val()=="0"||$("#formula_bangunan").val()==""||$("#formula_bangunan").val()==null)
                {
                    $("#formula_bangunan").val('1').trigger('change');
                }

                $("#bangunan_fix").attr('readonly', true);
                if ($("#bangunan_fix").val()==""||$("#bangunan_fix").val()==null)
                {
                    $("#bangunan_fix").val('0');
                }
        ...
        $("#flag_kavling").change(function() {
            if ($("#flag_kavling").is(':checked')) {
                ...
                $("#formula_kavling").val('0').trigger('change');
                ...
                if ($("#formula_kavling").val()=="0"||$("#formula_kavling").val()==""||$("#formula_kavling").val()==null)
                {
                    $("#formula_kavling").val('1').trigger('change');
                }

                $("#kavling_fix").attr('readonly', true);
                if ($("#kavling_fix").val()==""||$("#kavling_fix").val()==null)
                {
                    $("#kavling_fix").val('0');
                }
