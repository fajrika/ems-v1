...
<div style="float:right">
	<h2>
		<button class="btn btn-warning" onClick="window.location.href='<?=site_url(); ?>/P_master_range_air?>'">
			<i class="fa fa-arrow-left"></i>
			Back
		</button>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/P_master_range_air/edit?id=<?=$dataRangeAir[0]['id']?>'">
...
<div class="x_content">
	<br />
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url(); ?>/P_master_range_air/edit?id=<?=$this->input->get('id'); ?>">
            ...
            <thead>
			 ...
			 <tbody id="tbody_range"> 
                ...
                <?php
                            ...
                            foreach ($dataRangeAirDetail as $v) {
								++$j;
								if($v['delete'] == 0){
									++$i;
									echo "<tr id='srow".$i."'>";
									echo "<td hidden><input name='id_range_air_detail[]' value='$v[id]'> </td>";
