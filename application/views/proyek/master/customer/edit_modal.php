...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url(); ?>/P_master_customer/edit_modal?id=<?=$this->input->get('id')?>">
		<div class="col-md-6 col-xs-12">
            <div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Kode</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" name="code" class="form-control disabled-form" readonly value="<?=$dataSelect->code?>" disabled>
				</div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<select name="gol_diskon_id" class="form-control select2 disabled-form" placeholder="-- Pilih Golongan Diskon --" disabled>
						<option value="" selected disabled>Pilih Golongan Diskon</option>
				
                    <?php
                            foreach ($dataGolonganDiskon as $v) {
                                echo "<option value='$v[id]' ";
                                echo $v['id']==$dataSelect->gol_diskon_id?'selected':'';
                                echo " >$v[name]</option>";
                            }
                        ?>
		...
		<div class="col-md-6 col-xs-12">
            ...
            <div class="form-group">
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					<select id="mobile_phone_1_select" class="form-control select2 disabled-form" name="mobile_phone_1_select" value="+62" disabled>
						<option value=""></option>
						<?php
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
					<input id="mobile_phone_1" type="text" class="form-control disabled-form" data-inputmask="'mask' : '(+99) 999999999999999'" name="mobile_phone_1" value="<?=$dataSelect->mobilephone1?>"  disabled>
				</div>
			</div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="">
                    <label>
                        <input id="active" type="checkbox" class="js-switch disabled-form" name="active" value='1' <?=$dataSelect->active == 1 ? 'checked' : ''; ?> disabled/> Aktif
                    </label>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#mobile_phone_1").val("<?=$dataSelect->mobilephone1?>")
