			...
			<div class="form-group">
				...
				<div id="lihat_range">
					<div class="col-md-9 col-sm-9 col-xs-12" style="display: flex;">
                    	...
                    	<button type="button" class="btn btn-primary btn-block detail-range disabled-form" style="height: 3.43rem; width: 9rem; margin-left: 1rem; margin-right: 0;" disabled="">Detail</button>
					</div>
				</div>
			</div>
			<div class="form-group">
