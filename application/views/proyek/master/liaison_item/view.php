...
<div style="float:right">
	<h2>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/proyek/master/liaison_item/add'">
					...
					<tbody>
						<?php
                            ...
                            foreach ($data as $key => $v) {
                                ...
                                echo"
                                    <td>
                                    <a href='".site_url()."/proyek/master/liaison_item/edit?id=$v->id' class='btn btn-primary col-md-10'>
...
<script>
	function confirm_modal(id) {
		...
		document.getElementById('delete_link_m_n').setAttribute("href", "<?= site_url('master/liaison_item/delete?id=" + id +
			"'); ?>");
