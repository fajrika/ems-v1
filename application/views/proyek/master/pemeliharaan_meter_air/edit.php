...
<div style="float:right">
	<h2>
		...
		<button class="btn btn-success" onClick="window.location.href='<?=site_url(); ?>/P_master_pemeliharaan_meter_air/edit?id=<?=$this->input->get('id')?>'">
...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/P_master_pemeliharaan_meter_air/edit?id=<?=$this->input->get('id')?>">
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="code" name="code" required="required" class="form-control col-md-7 col-xs-12 disabled-form"
				 placeholder="-- Masukkan Kode Pembayaran --" value="<?=$data_select->code?>" disabled>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="ukuran_pipa" name="ukuran_pipa" required="required" class="form-control col-md-7 col-xs-12 disabled-form currency"
				 placeholder="-- Masukkan Ukuran Dim --" value="<?=$data_select->ukuran_pipa?>" disabled>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="biaya_admin">Harga Sewa<span class="required">*</span>
			</label>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="harga_sewa" name="harga_sewa" required="required" class="numberings form-control col-md-7 col-xs-12 disabled-form currency"
				 onchange="numberWithCommas(this.value)" value="<?=$data_select->harga?>" disabled>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="biaya_admin">Biaya Pasang Baru<span class="required">*</span>
			</label>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="biaya_pasang_baru" name="biaya_pasang_baru" required="required" class="form-control col-md-7 col-xs-12 disabled-form currency"
