...
<div style="float:right">
	<h2>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/P_master_pemeliharaan_meter_air/add'">
		...
		<div class="col-sm-12">
			<div class="card-box table-responsive">
				...
				<tfoot id="tfoot" style="display: table-header-group">
						...
						<th>No</th>
							<th>Kode</th>
							<th>Ukuran Pipa (dim)</th>
							<th>Harga Sewa</th>
							<th>Biaya Pasang Baru</th>
							<th>Keterangan</th>
							<th>Status</th>
							<th hidden>Action</th>
							<th hidden>Delete</th>
                ...
                foreach ($data as $key => $v) {
                    ...
                    echo"
                        <td class='col-md-1'>
                          <a href='".site_url()."/P_master_pemeliharaan_meter_air/edit?id=$v[id]' class='btn btn-sm btn-primary col-md-12'>
...
<script>
	function confirm_modal(id) {
		...
		document.getElementById('delete_link_m_n').setAttribute("href",
			"<?= site_url('P_master_pemeliharaan_meter_air/delete?id=" + id + "'); ?>");
