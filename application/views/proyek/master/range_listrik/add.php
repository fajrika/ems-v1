...
<!DOCTYPE html>
  ...
  <div class="x_content">
      <br>
      <form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/P_master_range_listrik/save">
...
<div class="col-md-9 col-sm-9 col-xs-12">
<input type="text" class="form-control currency" value="0" id="range_fix" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);"  required name="range_fix" placeholder="Masukkan Range Fix">
</div>
</div>
</div>
					...
					<div id="range" class="col-md-7 col-xs-12">
						<table class="table table-responsive">
							<thead>
								<tr>
									<th>Range</th><th>Range Awal</th><th>Range Akhir</th><th>Harga HPP</th><th>Harga Range</th><th>Hapus</th>
								</tr>
							</thead>
