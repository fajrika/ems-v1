...
<div style="float:right">
	<h2>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url()?>/P_master_range_listrik/add'">
		...
		<div class="col-sm-12">
			<div class="card-box table-responsive">
                ...
                echo'<tr>';
                    ...
                    echo "
                        <td class='col-md-1'>
                          <a href='".site_url()."/P_master_range_listrik/edit?id=$v[id]' class='btn btn-sm btn-primary col-md-12'>
...
<script>
	function confirm_modal(id) {
		...
		document.getElementById('delete_link_m_n').setAttribute("href", "<?= site_url('P_master_range_listrik/delete?id=" +
			id + "'); ?>");
