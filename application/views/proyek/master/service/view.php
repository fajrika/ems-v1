                ...
                <table class="table table-striped jambo_table tableDT">
                    <tfoot id="tfoot" style="display: table-header-group">
                        <tr>
                            ...
                            <th style="text-align : center">Kode PPN</th>
                            <th style="text-align : center">COA</th>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $key => $v) {
                            ...
                            echo "<td>$v->coa_service_code</td>";
                            echo "<td>$v->coa_service</td>";
                            echo "<td>$v->coa_ppn_code</td>";
                            echo "<td>$v->coa_ppn</td>";
                            echo "<td>";
                            echo $v->ppn_flag == "Aktif" ? '10%' : 'Tidak Ada';
                            echo "</td>";
                            //echo("<td>");
...
<script>
    function confirm_modal(id) {
        ...
        document.getElementById('delete_link_m_n').setAttribute("href",
            "<?= site_url('P_master_service/delete?id=" + id + "'); ?>");
