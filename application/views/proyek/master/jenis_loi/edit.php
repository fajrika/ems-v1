        ...
        <div class="col-md-12 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select required="" id="kategori" disabled name="kategori_loi_id" class="form-control select2">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Kode Jenis LOI</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" disabled name="kode" id="kode" value="<?=$dataSelect->kode?>" placeholder="Masukkan Kode Jenis LOI">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Jenis LOI</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" disabled name="nama" id="nama" value="<?=$dataSelect->nama?>" placeholder="Masukkan Nama Jenis LOI">
                </div>
            </div>
        </div>
		<div class="col-md-12">
        ...
        $(function() {
            ...
            $("#form").submit(function(e){
                ...
                $.ajax({
                    type: "GET",
                    data: $("#form").serialize(),
                    url: "<?= site_url() ?>/P_master_jenis_loi/ajax_edit?id=<?=$dataSelect->id?>",
                    dataType: "json",
