...
<div style="float:right">
	<h2>
		...
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/P_master_golongan/edit?id=<?=$dataGolongan[0]['id']?>'">
...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url(); ?>/P_master_golongan/edit?id=<?=$this->input->get('id'); ?>">
		<?php
           // echo("<pre>");
          //  print_r($data_select);
          //  echo("</pre>") ;
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="code" name="code" required="required" class="form-control  disabled-form" value="<?=$data_select->code; ?>" disabled>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<textarea id="keterangan" class="form-control  disabled-form" type="text" name="keterangan" disabled><?=$data_select->description; ?></textarea>
			</div>
		</div>
