...
<div class="x_content">
	...
	<div class="x_content">
		<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?= site_url(); ?>/P_master_unit/edit_modal?id=<?= $this->input->get('id'); ?>">
			...
			<div class="col-md-6 col-xs-12">
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<select id="pemilik" name="pemilik" required="" class="form-control select2 disabled-form" disabled>
							<option value="">--Pilih Pemilik--</option>
							<?php if ($dataPemilik->id != 0) : ?>
								<option selected value="<?= $dataPemilik->id ?>"><?= $dataPemilik->name ?></option>
							<?php endif; ?>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<select name="penghuni" class="form-control select2 disabled-form" disabled>
							...
							<?php if ($dataPenghuni->id != 0) : ?>
								<option selected value="<?= $dataPenghuni->id ?>"><?= $dataPenghuni->name ?></option>
							<?php endif; ?>
						</select>
					</div>
				</div>
			...
			<div class="col-md-6 col-xs-12">
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" class="form-control disabled-form" required name="virtual_account" value="<?= $dataSelect->virtual_account ?>" required="" placeholder="Masukkan Nomor Virtual Account" disabled>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-4 col-md-9 col-sm-9 col-xs-12">
						<div class="">
							<label>
								<input type="checkbox" class="kirim_tagihan js-switch" name="kirim_tagihan[]" value='1' <?= $dataSelect->kirim_tagihan == 1 || $dataSelect->kirim_tagihan == 3 ? "checked" : "" ?>> Pemilik
							</label>
						</div>
					</div>
					<div class="col-lg-5 col-md-9 col-sm-9 col-xs-12">
						<div class="">
							<label>
								<input type="checkbox" class="kirim_tagihan js-switch" name="kirim_tagihan[]" value='2' <?= $dataSelect->kirim_tagihan == 2 || $dataSelect->kirim_tagihan == 3 ? "checked" : "" ?>> Penghuni
							</label>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<div class='input-group date '>
							<input type="text" class="form-control datetimepicker disabled-form" name="tgl_st" id="tgl_st" placeholder="<?= $dataSelect->tanggal_st ?>" value="<?= $dataSelect->tanggal_st ?>" disabled readonly>
										...
										<div class="col-md-9 col-sm-9 col-xs-12" id="isi_air">
											...
											<select name="sub_golongan_air" class="form-control select2 disabled-form" id="sub_golongan_air" disabled>
												...
												foreach ($dataSubGol as $v) {
													if ($v['range_flag'] == 2) {
														echo "<option value='$v[id]'";
														echo ($v['id'] == $dataSelect->air_sub_golongan) ? 'selected' : '';
	...
	$(function() {
		$("#pemilik").select2({
			...
			ajax: {
				type: "GET",
				dataType: "json",
				url: "<?= site_url() ?>/P_master_unit/get_ajax_customer",
