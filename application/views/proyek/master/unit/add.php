        ...
        <div class="x_content">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select id="pemilik" name="pemilik" required class="form-control select2 customer" data-placeholder="Pilih Pemilik"></select>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Penghuni</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select id="penghuni" name="penghuni" class="form-control select2 customer" data-placeholder="Pilih Penghuni" disabled></select>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function select2(selector, url) {
            $(selector).select2({
                width: '100%',
                ajax: {
                    url: `${site_url}/P_master_unit/${url}`,
                    beforeSend: e => {
                        $("#loader").show()
                    },
                    complete: e => {
        ...
        $(function() {
            ...
            select2('.customer', 'ajax_get_customer');
