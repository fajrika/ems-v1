...
<div style="float:right">
	<h2>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/P_master_parameter_project/add'">
		...
		<div class="col-sm-12">
			<div class="card-box table-responsive">
                ...
                foreach ($data as $key => $v) {
                    ...
                    echo"
                        <td class='col-md-1'>
							<a href='".site_url()."/P_master_parameter_project/edit?id=$v[id]' class='btn btn-sm btn-primary col-md-12'>
