...
<div class="x_content">
    <br>
    <form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?= site_url() ?>/P_master_hargasewa/save">

        <div class="col-md-6 col-xs-12">
            <div class="form-group">
                <label class="control-label col-md-4 col-sm-3 col-xs-12">Kode Range<br>Harga Sewa</label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <input type="text" class="form-control" required name="kode_harga" placeholder="Masukkan Kode Harga Sewa">
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-md-4 col-sm-3 col-xs-12">Nama Range <br>Harga Sewa</label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <input type="text" class="form-control" required name="nama" placeholder="Masukkan Nama Sewa">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-md-4">DP Sewa ( Rp )</label>
                <div class="col-md-8">
                    <input type="text" value="0" id="deposit_sewa" class="form-control currency" required name="deposit_sewa" placeholder="IDR">
                </div>
            </div>
        ...
        <div class="col-md-6 col-xs-12">
            <div id="view_formula_bangunan">
                <div class="form-group">
                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Formula Bangunan Sewa</label>
            ...
            <div id="view_formula_kavling">
                <div class="form-group">
                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Formula Kavling Sewa</label>
                    <div class="col-md-2 col-sm-3 col-xs-12">
                        <div class="">
                            <label>
            ...
            <div class="form-group">
                <label class="control-label col-md-4">Biaya Bangunan Sewa Fix ( Rp )</label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label class="control-label col-md-4">Biaya Kavling Sewa Fix ( Rp )</label>
                <div class="col-md-8">
