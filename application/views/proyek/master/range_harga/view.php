...
<div style="float:right">
  <h2>
    <button class="btn btn-primary" onClick="window.location.href='<?= site_url() ?>/P_master_hargasewa/add'">
        ...
        <table class="table table-striped jambo_table tableDT">
          ...
          <tbody>
            ...
            //   echo "</td>";
              ...
              echo "
                    <td class='col-md-1'>
                      <a href='" . site_url() . "/P_master_hargasewa/edit?id=$v[id]' class='btn btn-sm btn-primary col-md-12'>
