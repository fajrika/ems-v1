    ...
    <form id="form" class="form-horizontal form-label-left">
        <div class="com-lg-6 col-md-6 col-xs-6">
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <select class="form-control select2" name="user_id" id="">
                        <option value="" disabled selected>Pilih User - Username</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <select class="form-control select2" name="jabatan_id" id="">
            ...
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Project</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <select class="form-control select2" name="project_id" id="">
                        <option value="" disabled selected>Pilih Project</option>
                        <?php foreach ($dataProject as $v):?>
                        <option value="<?=$v->id?>"><?=$v->name?></option>
                        <?php endforeach;?>
                    </select>
                </div>
        ...
        $(function() {
            ...
            $("#submit").click(function(){
                $.ajax({
                    type: "GET",
                    data: $("#form").serialize(),
                    url: "<?= site_url() ?>/Setting/Akun/Group/ajax_save",
                    dataType: "json",
