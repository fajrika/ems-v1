...
<div style="float:right">
	<h2>
		<button class="btn btn-primary" onClick="window.location.href='<?=site_url(); ?>/Setting/Akun/Group/add'">
	...
	<table id="tableDT2" class="table table-striped jambo_table bulk_action">
		...
		<tbody>
            ...
            foreach ($data as $key => $v) {
                ...
                echo "
                        <td class='col-md-1'>
                        <a href='".site_url()."/Setting/Akun/Group/edit?id=$v->id' class='btn btn-md btn-primary col-md-12'>
	...
	<script>
		$(".delete_data").click(function () {
			...
			if (r == true) {
				...
				url = '<?=site_url(); ?>/Setting/Akun/Group/delete';
				var id = $(this).attr('id');
